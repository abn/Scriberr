...
import { User, Settings as SettingsIcon, Key, Bot, FileText, Plus, Terminal, Server } from "lucide-react";
import {
  Tabs,
  TabsContent,
  TabsList,
  ...
  return (
    ...
    >
      ...
      <div className="bg-[var(--bg-card)] border border-[var(--border-subtle)] shadow-[var(--shadow-card)] rounded-[var(--radius-card)] p-2 sm:p-6 mt-8">
        ...
        >
          <TabsList className="grid w-full grid-cols-4 sm:grid-cols-7 items-center h-auto bg-[var(--bg-main)]/50 border border-[var(--border-subtle)] p-1 rounded-xl">
            <TabsTrigger
              value="transcription"
